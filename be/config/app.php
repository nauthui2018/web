...
return [
    ...
    */
    ...
    'aws_certificates_folder' => env('AWS_CERTIFICATES_FOLDER', 'certificates'),
    'aws_documents_folder' => env('AWS_DOCUMENTS_FOLDER', 'documents'),
    'aws_media_folder' => env('AWS_MEDIA_FOLDER', 'media'),
    'aws_temp_folder' => env('AWS_TEMP_FOLDER', 'temp'),
